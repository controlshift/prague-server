...
describe UsersController do
  ...
  describe '#create' do
    it 'should allow creation' do
      post :create, user: {email: 'george@washington.com', password: 'password', password_confirmation: 'password', organization_attributes: {name: 'George for President' } }
      expect(response).to be_redirect
    end

    it 'should create with invitation' do
      post :create, user: {email: 'george@washington.com', password: 'password', password_confirmation: 'password' }, invitation_token: invitation.token
      expect(response).to be_redirect
    end
  end
end